<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="转正日期" prop="zhuanzhengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhuanzhengriqi" 
                type="date"
                placeholder="转正日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuanzhengriqi" label="转正日期" prop="zhuanzhengriqi">
              <el-input v-model="ruleForm.zhuanzhengriqi" 
                placeholder="转正日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="转正说明" prop="zhuanzhengshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="转正说明"
                  v-model="ruleForm.zhuanzhengshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanzhengshuoming" label="转正说明" prop="zhuanzhengshuoming">
                    <span>{{ruleForm.zhuanzhengshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	banji : false,
	zhuanye : false,
	zhuanzhengriqi : false,
	zhuanzhengshuoming : false,
	gonghao : false,
	userid : false,
      },
      ruleForm: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanye = true;
          ...
          if(o=='zhuanzhengriqi'){
            this.ruleForm.zhuanzhengriqi = obj[o];
	    this.ro.zhuanzhengriqi = true;
            continue;
          }
          if(o=='zhuanzhengshuoming'){
            this.ruleForm.zhuanzhengshuoming = obj[o];
	    this.ro.zhuanzhengshuoming = true;
            continue;
          }
          if(o=='gonghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangyuanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
