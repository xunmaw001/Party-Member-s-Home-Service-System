  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="资料类型" prop="ziliaoleixing">
              <el-input v-model="ruleForm.ziliaoleixing" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="资料内容" prop="ziliaoneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ziliaoneirong" label="资料内容" prop="ziliaoneirong">
                    <span>{{ruleForm.ziliaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
