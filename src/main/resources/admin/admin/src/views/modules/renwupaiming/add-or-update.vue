<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="完成次数" prop="wanchengcishu">
          <el-input v-model="ruleForm.wanchengcishu" 
              placeholder="完成次数" clearable  :readonly="ro.wanchengcishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="完成次数" prop="wanchengcishu">
              <el-input v-model="ruleForm.wanchengcishu" 
                placeholder="完成次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	gonghao : false,
      ...
      rules: {
          ...
          wanchengcishu: [
                { required: true, message: '完成次数不能为空', trigger: 'blur' },
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renwupaiming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renwupaimingCrossAddOrUpdateFlag = false;
						 this.parent.search();
